...
#html Journal.rb
# org-Journal
# export individual days to html
# C-x C-e h o
# this script makes a clickable list of all the previous journals in
# ~/journal.d
require 'fileutils'
FileUtils.touch 'journalList.html'
journalList.html << Dir.glob("*.txt")
